                    ...
                    <form method="post" action="{{ route('update.product',$products->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="cat_id">Category Name</label>
                                 <select id="" class="custom-select" name="cat_id">
                                    <option value="{{$products->cat_id}}">{{$products->name}}</option>
                            ...
                            <div class="form-group col-md-6">
                               <label for="subcat_id">Subcategory_Name</label>
                                <select id="subcat_id" class="custom-select" name="subcat_id"> 
                                    <option value="{{$products->sub_id}}">{{$products->sub_name}}</option>
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="brand_name" value ="{{$products->brand_name}}">            
                              ...
                              <div class="form-group col-md-6">
                                <label for="product_name">Product Name</label>
                                 <input id="product_name" class="custom-select" name="product_name" value ="{{$products->product_name}}">
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_weight">Product Weight</label>
                                 <input id="product_weight" class="custom-select" name="product_weight" value ="{{$products->product_weight}}">
                            ...
                            <div class="form-group col-md-6">
                                <label for="product_stock">Product Stock</label>
                                 <input id="product_stock" class="custom-select" name="product_stock" value ="{{$products->stock}}" >
							...
							<div class="form-group col-md-6">
                                <label for="color_id">Product Color</label>
                                 <select id="color_id" class="custom-select" name="color_id"  value ="{{$products->color_id}}">
                                    <option value="{{$products->color_id}}">{{$products->color_name}}</option>
                            ...
                            <div class="form-group col-md-6">
                                <label for="size_id">Product Size</label>
                                 <select id="size_id" class="custom-select" name="size_id" value ="{{$products->size_id}}">    
                                    <option value="{{$products->size_id}}">{{$products->size_name}}</option>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="" class="custom-select" name="status">
                                    ...
                                    <option {{$products->status == 1 ?'selected' : ''}}  value="1">Open</option>
                                    <option {{$products->status == 0 ?'selected' : ''}}  value="0">Close</option>
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                <label for="price">Product price</label>
                                 <input id="product_stock" class="custom-select" name="price" value ="{{$products->price}}" >
                                @if ($errors->has('price'))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="" class="custom-select" name="discount" value = "{{$products->discount}}"  >
                            ...
                            <div class="form-group col-md-5">
                                <label for="single_image">Singe Image</label>
                                <input class="form-control" type="file" name="single_image">

                                @if ($errors->has('single_image'))
                                    <p class="text-danger">{{ $errors->first('single_image') }}</p>
                                @endif
                            </div>
                              <div class="form-group col-md-1">
                              <img style="width: 60px; height: 60px" src="{{asset('uploads/products/'.$products->single_image)}}">
                            </div>
                        ...
                        <input class="btn btn-success col-md-12" type="update" name="update" value="UPDATE">
                    </form>
                </div>
            </div>
